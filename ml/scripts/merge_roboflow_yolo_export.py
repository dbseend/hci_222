#!/usr/bin/env python3
"""
Merge a Roboflow YOLO export into dataset_sources/cherry_tomato_yolo.
...
TARGET = ROOT / "dataset_sources" / "cherry_tomato_yolo"
TARGET_CLASSES = ["cherry_tomato"]
CLASS_REMAP_BY_NAME = {
    "tomato": "cherry_tomato",
    "ripe": "cherry_tomato",
    "unripe": "cherry_tomato",
    "reject": "cherry_tomato",
    ...
    "cherrytomato": "cherry_tomato",
    "cherry-tomato": "cherry_tomato",
    "fully_ripened": "cherry_tomato",
    "semi_ripened": "cherry_tomato",
    "green": "cherry_tomato",
}
...
def reset_target() -> None:
    ...
    (TARGET / "metadata" / "imports").mkdir(parents=True, exist_ok=True)


def write_target_data_yaml() -> None:
    names = "[" + ", ".join(f"'{class_name}'" for class_name in TARGET_CLASSES) + "]"
